# 📊 SQL Exercise 1 — Pixar Movies

This project demonstrates basic SQL queries using the `movies` table.
...
- Learned how to use `SELECT` statements  
- Retrieved single and multiple columns  
- Used `*` to fetch complete table data  
